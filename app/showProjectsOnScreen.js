    ...
    sectionProjects.innerHTML += `
                ...
                <ul class="projects__container__list">
                    <li class="projects__container__item">
                        <a class="projects__container__image" href="${project.homepage}" target="_blank">
                            <img src="./img/${project.name}.png" alt="${project.description}">
                        </a>
                        ...
                        <div class="projects__container__div">
                            <a class="projects__container__link" href="${project.homepage}" target="_blank">📃 Access page</a>
